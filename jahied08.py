...
psb('\x1b[1;32mBANGLADESH 08 DIGIT CLONING TOOL IS STARTING PLEASE WAIT ..........')
for n in range(7777):
...
while loop == 'true':
    ...
    if username == CorrectUsername:
        ...
        if password == CorrectPassword:
            ...
            os.system('xdg-open https://www.facebook.com/ROOT.OFF.JAHIED')
    else:
        print '\x1b[1;97mWrong Username'
        os.system('xdg-open https://www.facebook.com/ROOT.OFF.JAHIED')

name = raw_input('\x1b[1;92m\x1b[1;92m Enter Your Name: ')
os.system('xdg-open https://www.facebook.com/ROOT.OFF.JAHIED/?ref=share')
...
def menu():
    ...
    print
    jalan('\x1b[1;90m[8] FIND ME ON FACEBOOK ID')
